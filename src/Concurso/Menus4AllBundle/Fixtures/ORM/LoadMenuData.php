...
class LoadMenuData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $menu1->setTipoMenu('desayuno');
        $menu1->setValoracion('valoracion-registrado');
        ...
        $menu2->setTipoMenu('comida');
        $menu2->setValoracion('valoracion-premium');
        ...
        $menu3->setTipoMenu('cena');
        $menu3->setValoracion('valoracion-admin');
