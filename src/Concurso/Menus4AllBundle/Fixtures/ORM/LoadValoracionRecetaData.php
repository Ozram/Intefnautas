...
class LoadValoracionRecetaData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $valoracionrec1->setUsuario($this->getReference('alberto'));
        ...
        $valoracionrec2->setUsuario($this->getReference('alberto'));
        ...
        $valoracionrec3->setUsuario($this->getReference('alberto'));
